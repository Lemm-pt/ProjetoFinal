    ...
    <div class="row my-5">
        ...
        <form action="?a=alterar_password_submit" method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" maxlength="30" name="text_password_atual" class="form-control" required>
            </div>

            <div class="form-group">
                <label>Nova password:</label>
                <input type="password" maxlength="30" name="text_nova_password" class="form-control" required>
            </div>

            <div class="form-group">
                <label>Repetir nova password:</label>
                <input type="password" maxlength="30" name="text_repetir_nova_password" class="form-control" required>
            </div>
